<form class='login-form' method="post" action="<?php echo constant('URL'); ?>login/authenticate">
  <div class="flex-row">
  ...
  <?php if(isset($this->d['error'])) { ?>
    <div class="alert alert-danger text-center error"><?php echo Encryption::decrypt($this->d['error']); ?></div>
  <?php } ?>
